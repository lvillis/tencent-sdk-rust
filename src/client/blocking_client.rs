use crate::{
    ...
    transport::{TransportConfig, blocking_transport::UreqBlockingTransport},
    types::Region,
...
struct Inner {
    ...
    transport: UreqBlockingTransport,
...
impl BlockingClient {
    pub fn builder(base_url: impl AsRef<str>) -> Result<BlockingClientBuilder> {
        BlockingClientBuilder::new(base_url.as_ref())
    }

    pub fn builder_tencent_cloud() -> Result<BlockingClientBuilder> {
        BlockingClientBuilder::new("https://tencentcloudapi.com")
    }

    pub fn billing(&self) -> crate::api::billing::BlockingBillingService {
        crate::api::billing::BlockingBillingService::new(self.clone())
    }

    pub fn tag(&self) -> crate::api::tag::BlockingTagService {
        crate::api::tag::BlockingTagService::new(self.clone())
    }

    pub fn cvm(&self) -> crate::api::cvm::BlockingCvmService {
        crate::api::cvm::BlockingCvmService::new(self.clone())
    }

    pub fn vpc(&self) -> crate::api::vpc::BlockingVpcService {
        crate::api::vpc::BlockingVpcService::new(self.clone())
    }

    pub fn cdn(&self) -> crate::api::cdn::BlockingCdnService {
        crate::api::cdn::BlockingCdnService::new(self.clone())
    }

    pub fn dns(&self) -> crate::api::dns::BlockingDnsService {
        crate::api::dns::BlockingDnsService::new(self.clone())
    }

    pub fn ssl(&self) -> crate::api::ssl::BlockingSslService {
        crate::api::ssl::BlockingSslService::new(self.clone())
    }

    pub(crate) fn execute<E: Endpoint>(
        &self,
        endpoint: &E,
        ...
        loop {
            ...
            let response = self.inner.transport.send(
                method.clone(),
                url.clone(),
                headers,
                body.clone(),
...
impl BlockingClientBuilder {
    ...
    pub fn build(self) -> Result<BlockingClient> {
        let transport = UreqBlockingTransport::new(&self.transport)?;
